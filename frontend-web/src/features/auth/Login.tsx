...
// Extrai a tipagem do schema para usar no TypeScript
...
export function Login() {
    ...
    // 3. Função chamada no submit do form
    const onSubmit = async (data: LoginFormInputs) => {
        try {
            setApiError('');
            await login(data);
            // Se deu certo, manda pra rota protegida
            ...
            <div className="w-full max-w-md space-y-8 rounded-xl bg-white p-8 shadow-lg">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div>
                        ...
                        />
                        {/* Mensagem de erro inline exigida nos requisitos */}
